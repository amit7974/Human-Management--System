		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link" href="addVendor">Add
							Vendor</a></li>
				</ul>
						...
						<input type="hidden" name="id" value="${vendor.id}">
							<div class="mb-3">
								<label>Enter  Full Name</label> <input type="text"
									name="fullName" class="form-control" value="${vendor.fullName }">
							</div>
							<div class="mb-3">
								<label>Enter Age</label> <input type="text" name="age"
									class="form-control" value="${vendor.age }">
							</div>
							...
							<div class="mb-3">
								<label>Enter phone</label> <input type="text"
									name="phone" class="form-control" value="${vendor.phone }">
							</div>
